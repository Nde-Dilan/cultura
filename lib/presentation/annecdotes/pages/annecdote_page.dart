...
import 'package:cultura/data/models/anecdotes/anecdote_model.dart';
import 'package:cultura/presentation/annecdotes/widgets/anecdote_widgets.dart';
...
class AnecdoteDetailScreen extends StatelessWidget {
  ...
  const AnecdoteDetailScreen({super.key, required this.anecdote});
          ...
          slivers: [
            ...
            SliverAppBar(
              ...
              leading: Platform.isIOS
                  ...
                  : IconButton(
                      icon: const Icon(Icons.arrow_back, color: seedColor),
                      onPressed: () => Navigator.pop(context),
                    ),
              actions: [
                IconButton(
  ...
  void _shareAnecdote(BuildContext context) {
    ...
    Share.share(
      'Hello! Here is a story I read from the Cultura app:\n\n'
      '${anecdote.title}\n\n'
      '${anecdote.content.length > 140 ? anecdote.content.substring(0, 150) : anecdote.content}...\n\n'
      'You can learn more here : https://Cultura-production.vercel.app/ \n\n'
      'Join me on Cultura, and let’s learn about our culture in a fun and engaging way!',
    );
  }
}
