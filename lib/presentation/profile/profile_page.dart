...
import 'package:cultura/presentation/profile/widgets/custom_inkwell.dart';
            ...
            children: [
                  ...
                  Positioned(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.edit, size: 15, color: darkColor),
                      ),
                    ),
                  ),
                ],
              ...
              BlocBuilder<UserInfoDisplayCubit, UserInfoDisplayState>(
                builder: (BuildContext context, state) {
                  if (state is UserInfoLoading) {}
                  if (state is UserInfoLoaded) {
                    return Text(state.user.firstName, style: style);
                  }
                  return Container();
                },
              ),
