...
import 'package:cultura/data/learning/models/learning_item.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: BackButton(),
        title: Text(widget.categoryName, style: AppTextStyles.h2),
        actions: [
          GestureDetector(
            onTap: () {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Image.asset(widget.categoryImage, width: mediaWidth(context) / 4.4),
        ],
      ),
    );
  }
