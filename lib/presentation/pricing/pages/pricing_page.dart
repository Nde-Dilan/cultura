...
import 'package:cultura/presentation/pricing/widgets/pay_button.dart';
import 'package:cultura/presentation/pricing/widgets/pricing_card.dart';
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Image.asset("assets/icons/pricing/new-Cultura-logo.png"),
        ],
      ),
    );
  }
