...
import 'package:cultura/data/stories/stories.dart';
import 'package:cultura/domain/auth/repository/stories_repository.dart';
import 'package:cultura/presentation/annecdotes/pages/annecdote_page.dart';
import 'package:cultura/presentation/learning/pages/home_category.dart';
...
Widget buildCarouselItem(int index, BuildContext context) {
  ...
  final Map<String, dynamic> story = Map<String, dynamic>.from(
    storiesList[index],
  );
    ...
    child: Column(
      ...
      children: [
        Container(
          ...
          child: Image.asset(category.imagePath, width: 40, height: 40),
        ),
        const SizedBox(height: 8),
        Text(
          category.title,
