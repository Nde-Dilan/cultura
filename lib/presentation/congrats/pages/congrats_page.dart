...
class CongratsPage extends StatefulWidget {
  ...
  const CongratsPage({super.key, required this.stats});
              ...
              child: Padding(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 40),
                    DoneButton(
                      onPressed: () => AppNavigator.push(context, HomePage()),
                    ),
                  ],
                ),
              ),
...
class TrophyImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Icon(Icons.emoji_events, size: 200, color: Colors.amber),
    );
  }
}
